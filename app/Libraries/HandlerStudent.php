...
class HandlerStudent 
{
    ...
    public function process($data) 
    {
        try
        {
            ...
            $alumnoFind = Alumnos::where(["usuario_sibal" => $this->data["student"]->data["usuario"]])->get();

            if(count($alumnoFind) > 0) // si el count regresa 1 o mayor el alumno existe
                return;
            ...
            Log::info($this->data["student"]->data);
        }
    }
}
