...
@if($alumnos->count() > 0)
    @foreach($alumnos as $alumno)
        <table width="100%">
            ...
            <tr>
                <td align="center">
                    <h2 style="font-size:16px;">{{$alumno->nombre_alumno}} {{$alumno->ap_paterno}} {{$alumno->ap_materno}}</h2>
                </td>
            </tr>
            <tr>
                
                <td align="justify">
                <BR><BR>CON EXPEDIENTE {{$alumno->Noexpediente}}, CURSO {{($alumno->Expediente->count() >= 42) ? "TOTALMENTE" : "PARCIALMENTE"}} EL PLAN DE ESTUDIOS DE EDUCACION MEDIA SUPERIOR EN LINEA, OBTENIENDO LAS CALIFICACIONES QUE A CONTINUACION SE ANOTAN:
                </td>
            </tr>
        </table>
        <br><br>
...
<table width="100%" style="font-size:9px;">
    <tr>
        <td width="28%">
            <img src="{{'C://wamp/www/sibal/public/students/'.$alumno->img}}"  alt="test" border="0" >
        ...
        <br><br><br><br><br><table width="100%" style="font-size:12px;">		
			<tr>
				<td align="justify">
                    <p>
